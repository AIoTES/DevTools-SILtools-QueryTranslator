...
export function RefreshToken(req: HttpRequest<any>) {
  ...
  ...NbAuthModule.forRoot({
    ...
    strategies: [
      NbPasswordAuthStrategy.setup({
        ...
        register: {
          // ...
          endpoint: environment.apiServer.endpoints.register,
          method: 'post',
        },
        login: {
          // ...
          endpoint: environment.apiServer.endpoints.login,
          method: 'post',
        },
        logout: {
          endpoint: environment.apiServer.endpoints.logout,
          method: 'post',
        },
        token: environment.apiServer.token
      }),
    ],
    forms: {
